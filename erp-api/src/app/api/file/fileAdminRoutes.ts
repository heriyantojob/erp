...
import {
    readFileAdmin,
} from "./controllers/fileAdminListController";
import {
    viewFileAdmin,
} from "./controllers/fileAdminViewController";
...
fileRouter.post('/add-file', authUserMiddleware,
    upload.single('file'),
    validateFileAddFile,
    addFile  // Changed from addFileTemplate
);

fileRouter.post('/add-design',
    upload.single('file'),
...
fileRouter.put('/update-file/:id',
     authUserMiddleware,
    validateFileUpdate,
    
    updateFile  // Changed from addProjectTemplate
);
fileRouter.put('/update-design/:id',
    authUserMiddleware,
...
fileRouter.post('/media', authUserMiddleware,
    upload.single('file'),
    validateFileAddFile,
    addFile  // Changed from addFileTemplate
);
