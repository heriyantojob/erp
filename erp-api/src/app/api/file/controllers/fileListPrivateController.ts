...
export async function readFilePrivate(req: Request, res: Response, next: NextFunction) {
...
export interface TableFileWithUserType {  // Changed interface name from TableTemplateWithUserType to TableFileWithUserType
