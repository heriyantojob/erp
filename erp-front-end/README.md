...
https://tailblocks.cc/?utm_source=tailkits&utm_medium=referral&utm_campaign=components
...
Open `http://localhost:3100/admin`. Set `NEXT_PUBLIC_ADMIN_ROUTE` and the API's `ADMIN_ROUTE` to the same value to change the entry path.
